    ...
    <div class="community-list-content">
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <div class="content-box">
              <p class="description">{{scope.row.descriptionString}}</p>
            </div>
          </template>
        </el-table-column>
        <el-table-column
      ...
      <el-dialog
        ...
        <div class="popout-box">
          ...
          <el-row>
            <el-col :span="5"><p>群组介绍<span>*</span></p></el-col>
            <el-col :span="19">
              <Editor id="oneEditor"
                      :toolbar="['bold','image']"
                      ref="oneEditor"
          ...
          <el-row>
            <el-col :span="5"><p>群组介绍栏目名称<span>*</span></p></el-col>
            <el-col :span="19">
              <el-input v-model="tabName3" maxlength="4" placeholder="请输入群组介绍内容"></el-input>
              <span class="size">4个字及以内</span>
            </el-col>
          </el-row>
          <el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /*确定新增和编辑*/
      handleConfor() {
        if (!this.tabName3 || !this.tabName2 || !this.tabName1 || !this.groupName || !this.groupDesc || !this.imageUrl || !this.riseId || !this.tips || !this.joinTips) {
      ...
      sendAddData() {
        let self = this;
        let param = {
          name: this.groupName, description: this.groupDesc, publish: parseInt(this.radio), tabName1: this.tabName1,
          tabName2: this.tabName2,tabName3: this.tabName3, joinTips: this.joinTips, tips: this.tips, image: this.imageUrl, riseId: this.riseId
        };
