    ...
    methods: {
      ...
      getData() {
        ApiDataFilter.request({
          ...
          successCallback: (res) => {
            ...
            this.getList(this.courseTitleList[0].id);
          ...
          successCallback: (res) => {
            ...
            if (this.courseList.length > 0) {
              this.courseList.forEach((item, index) => {
                this.courseList[index]['descriptionString'] = removeHtmlTags(item.description)
              })
            }
          }
        });
      ...
      handleSendAdio(name) {
        let param = {
          ...
          name: '',
          words: '',
          referenceId: this.searchCourseTitleValueId
        };
        ApiDataFilter.request({
          ...
          data: param,
          successCallback: (res) => {
            this.audioId = res.msg;
            this.handleSend(this.audioId)
          }
        })
      },
      /*提交*/
