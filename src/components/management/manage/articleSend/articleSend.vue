  ...
  <div class="article-send-container">
    ...
    <div class="article-send-top">
      <el-row>
        ...
        <el-col :span="6"
                v-if="type==TYPEFLAG.TEXTPIC">
          <div class="grid-content">
            标题：<el-input v-model="material.title"
        ...
        <el-col :span="6"
                v-if="type==TYPEFLAG.TEXTPIC">
          <div class="grid-content">
            摘要：<el-input v-model="material.digest"
      ...
      <el-row v-if="type==TYPEFLAG.TEXTPIC">
        <el-col :span="6">
          <div class="grid-content">
            作者：<el-input v-model="material.author"
                      placeholder="请输入作者"></el-input>
          </div>
        </el-col>
        <el-col :span="12">
          <div class="grid-content">
            正文：<el-input type="textarea"
                      :rows="2"
                      placeholder="请输入正文"
                      v-model="material.content"></el-input>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="grid-content">
