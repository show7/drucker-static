<template>
  <div class="user-info">
    ...
    <el-tabs type="border-card"
            ...
            <el-row>
              <el-col :span="12">
                <el-input v-model="inputValue"
                          placeholder="输入学号/ProfileId/RiseId/昵称查询"></el-input>
                <el-button type="primary"
                           @click="getUserInfo">点击查询</el-button>
              </el-col>
              <el-col :span="12">
      ...
      <el-tab-pane label="班级和小组搜索"
                   name="second">
        <div class="info-top">
          <el-select v-model="classValue"
                     placeholder="请选择班级名"
                     @change="handleGroupChange">
            <el-option v-for="item in GroupData.className"
                       :key="item"
                       :label="item"
                       :value="item">
            </el-option>
          ...
          <el-select v-model="groupValue"
                     placeholder="请选择小组">
            <el-option v-for="item in groupIds"
                       :key="item"
                       :label="item"
                       :value="item">
            </el-option>
          ...
          <el-button type="primary"
                     @click="getGroupList(1)">点击查询</el-button>
        </div>
        <div class="user-list">
          <el-table :data="tableGroupData"
                    border
                    style="width: 100%">
            <el-table-column type="index"
                             width="150"
    ...
    <el-dialog title="信息"
      ...
      <div class="dialog-user">
        <h3>优惠券信息</h3>
        <ul v-for="(item, index) in personData.coupons"
            :key="index">
      ...
      <div class="dialog-user">
        <h3>会员信息</h3>
        <ul v-for="(item, index) in personData.memberInfoVOs"
            :key="index">
